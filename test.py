...
from helpers.g_sheet import get_g_worksheet,append_row_to_worksheet,get_all_records_from_worksheet
...
if __name__ == "__main__":
    ...
    if drive:
        ...
        if ws:
            success = append_row_to_worksheet(ws, ["Test2", "Data", "123","2024-06-01", "https://example.com/receipt.jpg","AI Analysis Result"])
            if success:
                print("Row appended successfully.")
            else:
                print("Failed to append row.")
            records = get_all_records_from_worksheet(ws)
            print(records)